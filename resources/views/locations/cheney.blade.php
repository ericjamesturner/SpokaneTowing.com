...
<div class="bg-blue-50 border-l-4 border-blue-600 p-4 my-6">
    <p class="font-semibold">🏫 Serving the Eastern Washington University community</p>
    <p class="text-gray-700">Located southwest of Spokane along State Route 904, Cheney presents unique towing challenges with its hilly terrain and busy campus area. Our experienced drivers are familiar with the area's layout, from the university campus to residential neighborhoods and the historic downtown district.</p>
</div>
...
<div class="bg-green-50 rounded-lg p-6 mb-6">
    <p class="text-lg font-semibold mb-2">⏱️ Response Time: <span class="text-green-700">30-40 minutes</span></p>
    <p>We understand the unique needs of the university community and provide student-friendly service with competitive rates. We're familiar with campus parking regulations and access routes.</p>
</div>
